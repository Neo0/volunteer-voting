...
//					echo $name;
	...
	abstract class Domain_passwdFactory{
		protected $scheme;
		abstract function createObject(array $array);
	}

	abstract class passwd_Mapper{
...
// 					$password="";
		...
		abstract function insert(Domain_passwdObject $obj);
		abstract function update(Domain_passwdObject $obj);
	}

	class passwd_collection implements Iterator{
		protected $raw=array();
		protected $objects=array();
		protected $factory;
		protected $pointer=0;
		protected $total=0;
		function __construct(array $raw,Domain_passwdFactory $factory){
			$this->raw=$raw;
